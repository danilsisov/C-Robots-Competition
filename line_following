            ...
            {   
                if(led){
                    ...
                    if(dig.l3 == 1 && dig.r3 == 1 && dig.l2 == 1 && dig.r2 == 1){
                        ...
                        printf("count %d \n",count);
                        if(count >= 5){//stops on the third line
                            motor_forward(0,0);// Stop motors
                            int stop;
                    ...
                    //if both do not detect te line
                     else if (dig.l1==0 && dig.r1==0){ 
                     //makes it turn left to get back to the line
                     motor_turn(0,200,0);   
                     printf("%5d %5d", ref.l1, ref.r1);
                     int miss; 
                     miss=xTaskGetTickCount();
                     //if goes out of the line -> prints time of the miss
